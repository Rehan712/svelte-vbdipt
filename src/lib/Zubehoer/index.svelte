<script>
	...
	import Filter from '$lib/Zubehoer/Filter.svelte';
	import Item from '$lib/Item.svelte';
	import res from '$lib/Zubehoer/res.js';
	...
	onMount(() => {
		// const endpoint =
		// 	'https://velophil.berlin/react-service.php?service=zubehor&access_token=VMoxiRv9pyrb6MvwMMYAfNbRiU63QcCnREf4R8FVhAazP3RLDt4AGt79PFsJKhhM';
		// fetch(endpoint)
		// 	.then((r) => r.json())
		// 	.then((r) => {
		// 		items = r[0].data;
